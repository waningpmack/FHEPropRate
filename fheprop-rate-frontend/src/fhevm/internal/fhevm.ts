...
async function resolve(
  ...
  console.log("[fhevm] resolve - chainId:", chainId, "providerOrUrl:", providerOrUrl);
  ...
  console.log("[fhevm] resolve - _mockChains:", _mockChains, "has chainId:", Object.hasOwn(_mockChains, chainId));
  ...
  if (Object.hasOwn(_mockChains, chainId)) {
    ...
    console.log("[fhevm] resolve - returning mock mode:", { isMock: true, chainId, rpcUrl });

    return { isMock: true, chainId, rpcUrl };
  }

  console.log("[fhevm] resolve - returning non-mock mode:", { isMock: false, chainId, rpcUrl });
...
export const createFhevmInstance = async (parameters: {
  ...
  console.log("[createFhevmInstance] Called with provider:", parameters.provider);
  ...
  if (isMock) {
    console.log("[createFhevmInstance] Mock mode detected, fetching metadata from:", rpcUrl);
    ...
    if (fhevmRelayerMetadata) {
      ...
      console.log("[createFhevmInstance] Mock instance created:", !!mockInstance);

      throwIfAborted();

      return mockInstance;
    } else {
      console.log("[createFhevmInstance] No FHEVM metadata found, mock mode not available");
    }
  }
