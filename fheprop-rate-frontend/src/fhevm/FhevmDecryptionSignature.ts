...
export class FhevmDecryptionSignature {
  ...
  private constructor(parameters: {
    ...
    // Simplified validation for build
    ...
    // @ts-expect-error - TypeScript inference issue with contractAddresses
  ...
  static async new(
    ...
    try {
      ...
      return new FhevmDecryptionSignature({
        publicKey,
        privateKey,
        contractAddresses: contractAddresses.map(addr => addr as `0x${string}`),
        startTimestamp,
        durationDays,
        signature,
